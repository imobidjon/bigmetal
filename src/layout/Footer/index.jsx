...
export default function Footer() {
  return (
    <Box sx={{ mt: { xs: 15, md: 0 } }}>
      ...
      <Box sx={{ background: "#323750", pt: "40px", mt: { xs: 0, md: 8 } }}>
        <div className="container">
          <Grid container>
            <Grid item xs={12} textAlign={"center"} md={2}>
              <img
                src={Logo}
                alt={"Logo"}
          ...
          <Box sx={{ display: { xs: "flex", md: "none" }, py: { xs: 3 }, justifyContent: {xs: 'center'} }}>
            <Button
              endIcon={
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                ...
                >
                  <path
                    d="M8.00004 1.99989C7.4696 1.99989 6.9609 2.21061 6.58582 2.58568C6.21075 2.96075 6.00004 3.46946 6.00004 3.99989C6.00004 4.53032 6.21075 5.03903 6.58582 5.41411C6.9609 5.78918 7.4696 5.99989 8.00004 5.99989C8.53047 5.99989 9.03918 5.78918 9.41425 5.41411C9.78932 5.03903 10 4.53032 10 3.99989C10 3.46946 9.78932 2.96075 9.41425 2.58568C9.03918 2.21061 8.53047 1.99989 8.00004 1.99989ZM4.6667 3.99989C4.66683 3.3692 4.84588 2.7515 5.18306 2.21851C5.52024 1.68552 6.00171 1.25912 6.57154 0.988842C7.14138 0.718562 7.7762 0.61549 8.40228 0.691597C9.02836 0.767704 9.62 1.01987 10.1085 1.4188C10.597 1.81773 10.9623 2.34706 11.1619 2.94531C11.3616 3.54355 11.3874 4.18617 11.2365 4.79852C11.0855 5.41087 10.7639 5.96782 10.309 6.40469C9.85413 6.84156 9.28465 7.14042 8.6667 7.26656V11.3332H7.33337V7.26656C6.58058 7.11264 5.90403 6.70347 5.41813 6.10825C4.93224 5.51302 4.6668 4.76826 4.6667 3.99989ZM2.07004 7.33322H5.33337V8.66656H3.26337L2.7447 13.3332H13.2554L12.7367 8.66656H10.6667V7.33322H13.93L14.7447 14.6666H1.25537L2.07004 7.33322Z"
                    fill="white"
                  />
                </svg>
              }
